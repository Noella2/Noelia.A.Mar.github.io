...
progressBar.addEventListener('mousedown', (e) => {
  ...
  // event when the mouse click is releas ed
...
/* Section with the element I implemented*/

/*mute/unmute adapted from play button code*/
function muteunmute(){
  console.log("check");
...
/*full/small-screen, checks if the document is not in full screen and if so, requests to go into full screen, otherwise, exit full screen 
(! = not)*/
